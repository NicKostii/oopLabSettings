...
Parameters::Parameters(connection speed, connection cost, connection premium_speed,
    connection premium_cost, connection volume_cost, connection weight_cost) :

    speed(speed), cost(cost), premium_speed_coef(premium_speed), premium_cost_coef(premium_cost),
    volume_cost_coef(volume_cost), weight_cost_coef(weight_cost) {}

Parameters::Parameters(const Parameters& pars) :
    speed(pars.speed), cost(pars.cost), premium_cost_coef(pars.premium_cost_coef),
    premium_speed_coef(pars.premium_speed_coef), volume_cost_coef(pars.volume_cost_coef), weight_cost_coef(pars.weight_cost_coef) {}
