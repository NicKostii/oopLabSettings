...
public:
    Parcel();
    Parcel(int weight, int volume, const Date& sending_date, const Date& receiving_date, int price, int origin, int destination, int id, 
        bool premium, string& sender, string& recipient);
